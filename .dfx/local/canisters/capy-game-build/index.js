...
import { idlFactory } from './capy-game-build.did.js';
export { idlFactory } from './capy-game-build.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CAPY_GAME_BUILD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./capy-game-build.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the capy-game-build canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./capy-game-build.did.js")._SERVICE>}
 */
export const capy_game_build = createActor(canisterId);
